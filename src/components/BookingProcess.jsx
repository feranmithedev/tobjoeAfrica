...
function BookingProcess() {
  ...
  useGsapReveal(sectionRef, '.booking-card', { start: 'top 72%', stagger: 0.08 })

  return (
    <section ref={sectionRef} className="relative overflow-hidden bg-black pt-16 pb-18 sm:pt-20 sm:pb-22">
      <div className="section-shell">
        <div className="booking-card max-w-3xl">
          <p className="section-kicker mb-4">Booking Process</p>
          <h2 className="section-title">Clear steps from inquiry to confirmed production.</h2>
        </div>
        ...
        <div className="mt-10 grid gap-4 md:grid-cols-2 xl:grid-cols-5">
          {bookingSteps.map((step, index) => {
            ...
            return (
              <article className="booking-card cinema-card rounded-lg p-5" key={step.title}>
