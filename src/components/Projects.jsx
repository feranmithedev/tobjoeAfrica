...
function Projects() {
  ...
  return (
    <section ref={sectionRef} id="projects" className="relative bg-black pt-14 pb-16 sm:pt-16 sm:pb-20">
      <div className="section-shell">
        <div className="project-reveal flex flex-col justify-between gap-8 lg:flex-row lg:items-end">
          <div className="max-w-3xl">
            ...
            <h2 className="section-title">Selected work with a cinematic pulse.</h2>
          </div>
        ...
        <div ref={gridRef} className="mt-9 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {visibleProjects.map((project, index) => (
            ...
            >
              ...
              <div className="relative flex h-full min-h-90 flex-col justify-end p-6">
                ...
                <p className="text-sm font-semibold uppercase tracking-[0.18em] text-white/50">{project.format}</p>
                <h3 className="mt-3 text-2xl font-semibold leading-tight">{project.title}</h3>
                <p className="mt-3 leading-7 text-white/64">{project.description}</p>
              </div>
            </article>
          ))}
        </div>
