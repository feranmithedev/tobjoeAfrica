      ...
      <div className="section-shell flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
        <div>
          <a className="flex items-center gap-3" href="#home">
            ...
            <span>
              <span className="block font-semibold uppercase tracking-[0.18em]">Tobjoe Africa</span>
              <span className="mt-1 block text-sm text-white/48">Capturing Stories. Creating Impact.</span>
            </span>
          </a>
        </div>
