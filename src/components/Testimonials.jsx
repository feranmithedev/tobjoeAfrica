...
function Testimonials() {
  ...
  return (
    <section
      ref={sectionRef}
      id="testimonials"
      className="relative bg-[#050505] pt-16 pb-18 sm:pt-20 sm:pb-22"
    >
      <div className="section-shell">
        <div className="testimonial-card max-w-3xl">
          <p className="section-kicker mb-4">Testimonials</p>
          <h2 className="section-title">
            Trusted by clients who care about the story.
          </h2>
        </div>
        ...
        <div className="mt-10 grid gap-4 lg:grid-cols-3">
          {testimonials.map((testimonial) => (
            <article
              className="testimonial-card cinema-card rounded-lg p-6"
