...
function IntroLoader({ onComplete }) {
  ...
  useEffect(() => {
    ...
    const context = gsap.context(() => {
      ...
      timeline
        ...
        .to(wordRef.current, {
          textShadow: '0 0 46px rgba(212, 175, 55, 0.95), 0 0 90px rgba(177, 18, 38, 0.38)',
          color: '#f4d76c',
          duration: 0.45,
        })
        .to('.intro-line', {
        ...
        .call(() => {
          window.dispatchEvent(new CustomEvent('tobjoe:camera-shutter-placeholder'))
        })
  ...
  return (
    ...
    >
      ...
      <div ref={frameRef} className="absolute h-[62vh] w-[min(760px,82vw)] border-y border-[#D4AF37]/45" />
      ...
      <div className="relative text-center">
        ...
        <p className="mb-5 text-xs font-bold uppercase tracking-[0.38em] text-white/50">Capturing Stories</p>
        <h1
          ref={wordRef}
        ...
        <span className="screen-reader-only">Camera shutter sound placeholder triggered.</span>
      </div>
