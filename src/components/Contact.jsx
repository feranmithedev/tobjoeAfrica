...
function Contact() {
  ...
  return (
    <section ref={sectionRef} id="contact" className="relative overflow-hidden bg-[#050505] pt-16 pb-18 sm:pt-20 sm:pb-22">
      ...
      <div className="section-shell relative">
        <div className="contact-reveal grid gap-10 rounded-lg border border-white/10 bg-black/55 p-6 backdrop-blur-xl sm:p-10 lg:grid-cols-[1fr_0.8fr] lg:p-14">
          <div>
            ...
            <h2 className="section-title">Ready to turn your moment into a visual story?</h2>
            <p className="section-copy mt-6">
              Share the project, the date, the audience, and the feeling you want people to remember. Tobjoe Africa
              will help shape the next step with clarity.
            </p>
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              <a className="primary-button" href="https://wa.me/2349130460914">
                Book on WhatsApp <ArrowRight size={18} />
              </a>
              <a className="secondary-button" href="mailto:tobjoeafrica@gmail.com">
            ...
            {contactLinks.map((link) => {
              ...
              return (
                ...
                >
                  ...
                  <span>
                    <span className="block text-sm font-semibold text-white/50">{link.label}</span>
