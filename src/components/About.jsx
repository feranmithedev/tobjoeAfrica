    ...
    >
      <div className="section-shell grid gap-12 lg:grid-cols-[0.85fr_1fr] lg:items-end">
        <div>
          ...
          <h2 className="reveal-item section-title">
            A visual studio for stories with weight.
          </h2>
        </div>
        <div className="reveal-item">
          <p className="section-copy">
            Tobjoe Africa creates cinematic films, sharp photography, and
            emotionally intelligent edits for people and organizations that care
            about excellence. From ministry events to business campaigns and
            personal milestones, the work is shaped to feel honest, premium, and
            memorable.
          </p>
        </div>
      </div>
      ...
      <div className="section-shell mt-10 grid gap-4 md:grid-cols-3">
        {values.map((item) => {
          ...
          return (
            <article
              className="reveal-item cinema-card rounded-lg p-6"
              key={item.title}
            >
